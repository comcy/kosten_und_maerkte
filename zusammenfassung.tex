...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/kostenstellenrechnung_ueberblick.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/kostenstellenplan.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/gemeinkosten.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/bab.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage 
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/leistungsaustauschmatrix.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/leistungsverechnung1.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/leistungsverechnung2.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/zuschlagssaetze.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/grundschema_zuschlagskalkulation.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/beispiel_zuschlagskalkulation.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/beispiel_zuschlagskalkulation2.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/beispiel_betriebsergebnisrechnung1.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
 \begin{center}
   \includegraphics[scale=0.3]{bilder/beispiel_betriebsergebnisrechnung2.png}
 \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
